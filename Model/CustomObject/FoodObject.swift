...
class FoodObject: NSObject {
    ...
    init(name: String, protein: NSNumber, surveyFlag: String,calcium: NSNumber,totalFat: NSNumber, sodium: NSNumber,vitaminC: NSNumber,vitaminA: NSNumber, surveyID: NSNumber) {
        self.name = name
