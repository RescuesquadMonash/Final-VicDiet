...
//                }
    ...
    func setupSectionThreeCell(tableView: UITableView, indexPath: IndexPath, cellTopLeftLabel: String, progress: Float, identifier: String) -> (NutrientProgressCell){
        ...
        if progress > 1{
            ...
            cell.middleKeyLabel.textColor = UIColor(red: 255/255, green: 99/255, blue: 71/255, alpha: 1)
            cell.progressView.progressTintColor = UIColor(red: 255/255, green: 99/255, blue: 71/255, alpha: 1)
            cell.progressTrackLabel.backgroundColor = UIColor(red: 255/255, green: 99/255, blue: 71/255, alpha: 1)
        }
        if progress <= 1{
