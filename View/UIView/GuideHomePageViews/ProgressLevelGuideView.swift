...
class ProgressLevelGuideView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        //                    endAngle: 2.0 * .pi,
        //                    clockwise: false)
        path.addRects([CGRect(x: frame.width/30, y: 64 + frame.height*0.02, width: frame.width - frame.width/15, height: frame.height*0.36),CGRect(x: 0, y: 0, width: frame.width, height: frame.height)])
