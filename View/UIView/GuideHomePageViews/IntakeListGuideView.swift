...
class IntakeListGuideView: UIView {
    ...
    let label: UILabel = {
        ...
        label.text = "The intake list is aiming to store what you have eaten in one day."
    ...
    override init(frame: CGRect) {
        ...
        label.topAnchor.constraint(equalTo: topAnchor, constant: 64 + frame.height*0.5).isActive = true
        ...
        //                    endAngle: 2.0 * .pi,
        //                    clockwise: false)
        path.addRects([CGRect(x: 5, y: 64 + frame.height*0.02, width: frame.width - 10, height: frame.height*0.45),CGRect(x: 0, y: 0, width: frame.width, height: frame.height)])
