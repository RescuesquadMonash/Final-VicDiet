...
class SubstituteResultSearchView: UIView, UITableViewDelegate, UITableViewDataSource{
    ...
    override init(frame: CGRect) {
        ...
        tableView.register(MatchingCell.self, forCellReuseIdentifier: cellId)
...
//        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: cellId, for: indexPath) as! MatchingCell
        if isSearching{
            ...
            let matchNumber = filteredFixedDimensionalArrayJoinedNew[indexPath.row].match
            cell.setupData(matchNumber: matchNumber, foodName: name, foodDetail: detail)
            ...
            let matchNumber = fixedDimensionalArrayJoinedNew[indexPath.row].match
            cell.setupData(matchNumber: matchNumber, foodName: name, foodDetail: detail)
            //cell.textLabel!.text = name
            //cell.detailTextLabel?.text = detail
        }
